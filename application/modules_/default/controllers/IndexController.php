...
class IndexController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        try { 
            ...
            $results_all = Model_DBTable_News::getInstance()->showAll();
    ...
    public function filesAction() {
        ...
        if ($session['log'] == 1) {
            try {
                ...
                $permisos = Model_DBTable_Archivos::getInstance()->getPermisos($suscriptor);
                //Buscamos los archivos con cada permiso
                $archivos = Model_DBTable_Archivos::getInstance()->getFilesByClearence($permisos, $this->parameters['sort'], $this->parameters['order']);
    ...
    public function contactAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            foreach($_POST as $key => $value){
                $_POST[$key] = mysql_escape_string(utf8_encode($value));
            }
