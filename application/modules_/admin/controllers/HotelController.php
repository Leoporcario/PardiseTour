...
class Admin_HotelController extends Zend_Controller_Action {
    ...
    public function editAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($_POST['eliminarRestobares']) {
                $eliminarRestobares = $_POST['eliminarRestobares'];
                unset($_POST['eliminarRestobares']);
            }
            ...
            try {
                ...
                if ($eliminarRestobares) {
                    $this->_hotel->deleteRestobares($eliminarRestobares);
                }
