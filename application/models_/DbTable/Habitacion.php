...
class Model_DBTable_Habitacion extends Zend_Db_Table_Abstract {

    private static $instance;
    protected $_name = 'adm_habitacion';
    protected $primary = 'idHabitacion';
    protected $defultSort = 'HHOrder';
    protected $defultOrder = 'ASC';
    
    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_Habitacion();
        }
