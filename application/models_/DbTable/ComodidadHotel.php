...
class Model_DBTable_ComodidadHotel extends Zend_Db_Table_Abstract {

    private static $instance;
    protected $_name = 'adm_comodidad-hotel';
    protected $primary = 'idComodidadHotel';
    protected $defultSort = 'CHOorden';
    protected $defultOrder = 'ASC';
    
    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_ComodidadHotel();
        }
