...
class Model_DBTable_Perfiles extends Zend_Db_Table_Abstract {
	
	protected $_name = 'adm_perfiles';	
	protected $primary = 'IDPerfil';
	
	protected $defultSort = 'PNombre';
    ...
    public function get($id) {
        ...
        if (!$row) {
            throw new Exception("No se encontro el perfil $id");
        }
        return $row->toArray();
    }
