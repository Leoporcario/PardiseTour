...
class Model_DBTable_Restobar extends Zend_Db_Table_Abstract {

    private static $instance;
    protected $_name = 'adm_restaurant';
    protected $primary = 'idGastronomia';
    protected $defultSort = 'RnombreEs';
    protected $defultOrder = 'ASC';

    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_Restobar();
        }
