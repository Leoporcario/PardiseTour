...
class Model_DBTable_ComodidadHabitacion extends Zend_Db_Table_Abstract {

    private static $instance;
    protected $_name = 'adm_comodidad-habitacion';
    protected $primary = 'idComodidadHabitacion';
    protected $defultSort = 'CHorden';
    protected $defultOrder = 'ASC';
    
    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_ComodidadHabitacion();
        }
