...
class Model_DBTable_Enlaces extends Zend_Db_Table_Abstract {
	
	protected $_name = 'adm_enlace';	
	protected $primary = 'IDEnlace';
        protected $defultSort = 'EnombreEn';
        ...
        public function showAll($where = null, $sort = null, $order = null, $limit = null) {
            ...
            $select->joinNatural('adm_enlace-categoria');
            $select->where($where);
