...
class Model_DBTable_EnlaceCategoria extends Zend_Db_Table_Abstract {
	
	protected $_name = 'adm_enlace-categoria';	
	protected $primary = 'IDEnlaceCategoria';
        protected $defultSort = 'ECnombreEs';
