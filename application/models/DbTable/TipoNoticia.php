...
class Model_DBTable_TipoNoticia extends Zend_Db_Table_Abstract {

    protected $_name = 'cms_tipo_noticia';
    protected $primary = 'IDTipoNoticia';
    protected $defultSort = 'TNNombre';
