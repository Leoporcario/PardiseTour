...
class Model_DBTable_Grupoislas extends Zend_Db_Table_Abstract {

    private static $instance;
    protected $_name = 'adm_grupo-isla';
    protected $primary = 'idGrupoIsla';
    protected $defultSort = 'GInombreEs';
    ...
    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_Grupoislas();
        }
