...
class Model_DBTable_ActividadHotel extends Zend_Db_Table_Abstract {

    private static $instance;
    protected $_name = 'adm_actividad-hotel';
    protected $primary = 'idActividadHotel';
    protected $defultSort = 'AHnombreEs';
    protected $defultOrder = 'ASC';

    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_ActividadHotel();
        }
