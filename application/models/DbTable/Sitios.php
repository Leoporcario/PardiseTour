...
class Model_DBTable_Sitios extends Zend_Db_Table_Abstract {
    
    private static $instance;
    protected $_name = 'adm_sitios';
    protected $primary = 'idSitios';
    protected $defultSort = 'ISnombreEs';
    protected $defultOrder = 'ASC';

    public static function getInstance() {
        if (!isset(self::$instance)) {
            self::$instance = new Model_DBTable_Sitios();
        }
    ...
    public function showAll($where = null, $sort = null, $order = null, $limit = null) {
        ...
        $select->joinLeft('adm_categoria_sitios as cs','adm_sitios.IDCategoriaSitio=cs.IDCategoriaSitio');
    ...
    public function resetLatLngByIsla($id) {
        ...
        $this->update(array('SIlat'=>null,'SIlng'=>null), 'idIsla = ' . (int) $id);
    }
